...
const CharactersDetails = () => {
  ...
  useEffect(() => {
    const getCharacters = async () => {
      ...
      setCharacter(characterJson);
        const housesApi = await fetch(`https://game-of-thrones-json-server.vercel.app/houses/${characterJson.house}`);
  ...
  return (
    <div className='characterDetails_contenedor_general'>
          ...
          <div>
 <button onClick={goBack} class="ov-btn-slide-top">Volver atrás</button>
          </div>
            <p>g</p>
    </div>
  );
